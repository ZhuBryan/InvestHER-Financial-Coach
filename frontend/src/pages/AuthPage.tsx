  ...
  return (
      ...
      <div className="flex-grow flex flex-col items-center py-16 px-8 w-full">
        ...
        >
          ...
          <p className="text-xl text-white font-light pb-8">
        ...
        >
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-[#2D2D2D] px-2 text-white font-medium">Sign up with</span>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4">
            <Button
              ...
              className="w-64 h-16 rounded-3xl bg-white hover:bg-white/90 transition-all duration-300 hover:scale-[1.02] shadow-xl active:scale-95 flex items-center justify-center gap-3 cursor-pointer"
            >
        ...
        <p className="text-center text-white text-base pt-8 py-8">
