...
function calculateLoanPayoff(
  ...
  while (standardBalance > 0 && standardMonths < 600) { // 50 year cap
    const interestCharge = standardBalance * monthlyRate;
    const principalPayment = Math.min(monthlyPayment - interestCharge, standardBalance);
  ...
  while (acceleratedBalance > 0 && acceleratedMonths < 600) {
    ...
    const principalPayment = Math.min(totalMonthlyPayment - interestCharge, acceleratedBalance);
...
export function InvestmentDashboard({ onBackToOnboarding }: { onBackToOnboarding?: () => void }) {
  ...
  const [goals, setGoals] = useState<Goal[]>([
    { id: '1', name: 'Emergency Fund', targetAmount: 1000, allocatedAmount: 100, color: '#FF88B7' },
    { id: '2', name: 'Vacation Fund', targetAmount: 500, allocatedAmount: 39.75, color: '#7B61FF' },
  ]);
  ...
  const [savingsHistory] = useState<SavingsItem[]>([
    { id: '1', company: 'UNIQLO', amount: 45.00, date: '2025-11-21', daysAgo: 1 },
    { id: '2', company: 'ARITZIA', amount: 28.50, date: '2025-11-21', daysAgo: 1 },
    { id: '3', company: 'LULULEMON', amount: 32.00, date: '2025-11-20', daysAgo: 2 },
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setGoals(goals.map(g => 
                                      g.id === goal.id ? { ...g, allocatedAmount: newAmount } : g
                                    ));
                                  }}
                ...
                <div className="flex items-center gap-6 flex-1">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-2xl flex items-center gap-2">
                      +${totalGain.toFixed(2)}
                      <span className="text-sm opacity-90">(+{gainPercentage}%)</span>
                    </div>
                  </div>
                  <div className="text-left">
                    <div className="text-xs opacity-75 mb-1">Money You Saved</div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1 text-left">
                    ...
                    <div className="text-5xl mb-3">${currentValue.toFixed(2)}</div>
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        <TrendingUp className="w-5 h-5" />
                        <span className="text-xl">+${totalGain.toFixed(2)}</span>
                      </div>
                  ...
                  <div className="text-right">
                    <div className="text-sm opacity-90 mb-2">Money You Saved</div>
                    <div className="text-3xl mb-3">${totalSaved.toFixed(2)}</div>
